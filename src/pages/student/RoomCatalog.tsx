...
import { Users, MapPin, LayoutTemplate, Search, CalendarCheck } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {rooms.map((room) => (
                        <div key={room.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition group">
            ...
            <SuccessModal
                ...
                message="Your request has been submitted. You can monitor the approval"
            />
        </div>
    );
};
